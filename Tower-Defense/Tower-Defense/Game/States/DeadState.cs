...
namespace Tower_Defense
{
    class DeadState : State
    {
        ...
        {
            StringManager.DrawStringMid(aSpriteBatch, my8bitFont, "GAME OVER", 
            ...
            StringManager.DrawStringMid(aSpriteBatch, my8bitFont, "Score: " + GameInfo.Score.ToString(), 
                new Vector2(aWindow.ClientBounds.Width / 2, (aWindow.ClientBounds.Height / 2) - 56), Color.LightSlateGray, 0.7f);
